...
## 📚 Table of Contents:
 ...
 - [Features](https://github.com/0marmazen/Projects-Writeups/blob/main/Projects/Portable-Network-Security-Assessment.md?tab=readme-ov-file#-features)
 - [Components](https://github.com/0marmazen/Projects-Writeups/blob/main/Projects/Portable-Network-Security-Assessment.md?tab=readme-ov-file#-components)
 - [Guide](https://github.com/0marmazen/Projects-Writeups/blob/main/Projects/Portable-Network-Security-Assessment.md?tab=readme-ov-file#%EF%B8%8F-guide)
...
|-------------------|-------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Board             | [Raspberry Pi 4 Model B (8GB)](https://www.amazon.ca/Raspberry-Pi-Model-Bluetooth-Enabled/dp/B09TTKT94J/ref=sr_1_11?keywords=Raspberry+pi+4&sr=8-11&ufe=app_do%3Aamzn1.fos.b06bdbbe-20fd-4ebc-88cf-fa04f1ca0da8) |   <img src="https://github.com/0marmazen/Projects-Writeups/assets/network-tool/Component1.png" alt="Board" width="350">                     |
| Display           | [Waveshare 3.5inch Touch Screen RPi LCD (C)](https://www.waveshare.com/3.5inch-rpi-lcd-c.htm)             |   <img src="https://github.com/0marmazen/Projects-Writeups/assets/network-tool/Component2.png" alt="Display (Top)" width="250"><img src=""https://github.com/0marmazen/Projects-Writeups/assets/network-tool/Component4.png" alt="Display (Bottom)" width="250"> |
...
| Network Adapter   | [ALPHA AWUS036ACS](https://www.amazon.ca/ALFA-NETWORK-AWUS036ACS-Alfa-Adapter/dp/B0752CTSGD/ref=sr_1_2?keywords=ALPHA+AWUS036ACS&sr=8-2) |   <img src="https://github.com/0marmazen/Projects-Writeups/assets/network-tool/Component3.png" alt="ALPHA Adapter" width="250">                     |
| Heatsink (optional) | [Aluminum Alloy Cooling Case by WEIYIXING](https://www.amazon.ca/dp/B0BBPPYV76?ref=ppx_yo2ov_dt_b_product_details&th=1)      |    <img src="https://github.com/0marmazen/Projects-Writeups/assets/network-tool/Component4.png" alt="Heatsink" width="250">                             |
